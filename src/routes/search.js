...
router.route('/').post(function(req, res) {
  ...
  var Rangess = 0;
  if (!req.body.range) Rangess = 100;
  else Rangess = parseFloat(req.body.range);
...
router.route('/nearby').post(function(req, res) {
  var Rangess = 0;
  if (!req.body.range) Rangess = 5;
  else Rangess = parseFloat(req.body.range);
...
router.route('/allproduct').post(function(req, res) {
  if (!req.query.id) {
